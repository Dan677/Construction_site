...
// Verifică dacă dark mode este activat dinainte și setează stilul corespunzător
...
darkModeToggle.addEventListener('click', () => {
    ...
    // Schimbă icon-ul în funcție de dark mode
    if (body.classList.contains('dark-mode')) {
        icon.classList.remove('fa-sun');
        icon.classList.add('fa-moon'); // Schimbă la lună pentru dark mode
        localStorage.setItem('darkMode', 'enabled');
    } else {
        icon.classList.remove('fa-moon');
        icon.classList.add('fa-sun'); // Schimbă la soare pentru light mode
